      ...
      <div className={styles.container}>
        ...
        <div className={styles.group}>
          ...
          <div className={styles.text}>
            ...
            <h2>
              We run our algorithms on your data, with the myze data pool (other’s input) to suggest the
              perfect size.
            </h2>
          </div>
        </div>
        <div className={styles.group}>
          ...
          <div className={styles.text}>
            ...
            <h2>You don’t have to worry about picking the correct size, according to the company that you
              are purchasing your shirt from.</h2>
          </div>
        </div>
      </div>
    </div>
