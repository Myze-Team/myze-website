  ...
  return (
    <div className={`${styles.aboutUsPage} ${styles.responsiveContainer}`}>
      ...
      <div className={styles.descriptionContainer}>
        <h1>at Myze, our goal is to create a confident shopping experience for the everyday online shopper.</h1>
      ...
      <div className={styles.missionContainer}>
        ...
        <h3>say hi to the chameleon, a chameleon changes color (“size” for myze), but is still the same animal (person).</h3>
      </div>
